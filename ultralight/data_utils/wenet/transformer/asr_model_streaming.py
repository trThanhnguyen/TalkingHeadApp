...
from wenet.transformer.decoder_streaming import (TransformerDecoder,
                                       BiTransformerDecoder)
from wenet.transformer.encoder_streaming import ConformerEncoder
from wenet.transformer.encoder_streaming import TransformerEncoder
...
class ASRModel(torch.nn.Module):
    ...
    def recognize(
        ...
        #print('encoder out shape **********', encoder_out.shape) #[1, 124, 256] [batch, time, feat-dim]
        ...
        #print('encoder out shape **********', encoder_out.shape) #[batch*beam, time , feat-dim]
        ...
        for i in range(1, maxlen + 1):
            ...
            #print(logp[0].max())#.size()) #[10, 11008]
            #print(logp.shape)
            #print(cache.shape)
            #print('***chche'*10, len(cache), cache[1].size())
            #assert 0==1
